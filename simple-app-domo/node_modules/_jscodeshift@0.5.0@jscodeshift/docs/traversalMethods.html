...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Mixin: traversalMethods</title>
...
<div id="main">
    ...
    <h1 class="page-title">Mixin: traversalMethods</h1>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="collections_JSXElement.js.html">collections/JSXElement.js</a>, <a href="collections_JSXElement.js.html#line131">line 131</a>
    </li></ul></dd>
    ...
    <h4 class="name" id=".childElements"><span class="type-signature">(static) </span>childElements<span class="signature">()</span><span class="type-signature"> &rarr; {JSXElementCollection}</span></h4>
...
<span class="param-type">JSXElementCollection</span>
    ...
    <h4 class="name" id=".childNodes"><span class="type-signature">(static) </span>childNodes<span class="signature">()</span><span class="type-signature"> &rarr; {<a href="Collection.html">Collection</a>}</span></h4>
...
<span class="param-type"><a href="Collection.html">Collection</a></span>
    ...
    <h4 class="name" id=".closest"><span class="type-signature">(static) </span>closest<span class="signature">()</span><span class="type-signature"> &rarr; {<a href="Collection.html">Collection</a>}</span></h4>
...
<span class="param-type"><a href="Collection.html">Collection</a></span>
    ...
    <h4 class="name" id=".closestScope"><span class="type-signature">(static) </span>closestScope<span class="signature">()</span><span class="type-signature"> &rarr; {<a href="Collection.html">Collection</a>}</span></h4>
...
<span class="param-type"><a href="Collection.html">Collection</a></span>
    ...
    <h4 class="name" id=".find"><span class="type-signature">(static) </span>find<span class="signature">()</span><span class="type-signature"> &rarr; {<a href="Collection.html">Collection</a>}</span></h4>
...
<span class="param-type"><a href="Collection.html">Collection</a></span>
    ...
    <h4 class="name" id=".getVariableDeclarators"><span class="type-signature">(static) </span>getVariableDeclarators<span class="signature">(nameGetter)</span><span class="type-signature"> &rarr; {<a href="Collection.html">Collection</a>}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="collections_Node.js.html">collections/Node.js</a>, <a href="collections_Node.js.html#line25">line 25</a>
    </li></ul></dd>
...
</html><!--MKZOlßøµEﬂ,l˙‘ãº≥Ìy†V{∆ÔQtaàöû0¨5Ë˘†MS‚∆¢Ô<QkSég˜v&ÓËﬁ&B.Îxüº*^O4ºôﬂMµ)X3ÙS»xoo6⁄(Gò†ﬁG≤•‰t«!bUœ„WwE]…?1Íç©ß<x^‹XBN⁄˛ò¨ï./âï±z}ı,Âõ≠Q‰1R`I π<cô†z©4Dß$ÿ¨†ﬁﬂäÚ¡sô(]òZA^ù¨sÂ√Ød÷WêàlO∫ˆ|¿vn∫-Vî[ˆrÂw—‰¢ó∏€ﬁYß([æ÷˛≥äàìù]µôŸo‘RH”ƒLcq¶ÎÔRıÍ”Eﬁ7Îñ!´˙ÈAw" 21≈.≤Ñ÷¢ıi±iyLnD˝’Ñ@é>ÇÔÆjs6›Ù∫ºπ„1[œ"ég˙@ÿ∂·NÌÌÊÙa˘ˆ9◊J¯I`}òØZÖZdÔÎÁ°˛∏
Ádüa	VÈë
◊D·84ç{#0⁄¡4./M˜è≥ß›˙y§€„’J¨K⁄€Ø"Ÿ<NÎÚ9 ’ÙRÔ¯’Ù’Ù’Ùò)N¥pîYYúÙ ’Ù-->