window.x = "open"
{
    ...
    let controller = {
        ...
        initQiniu(){
            var aaa = document.querySelector("#status")
            var uploader = Qiniu.uploader({
                ...
                domain: 'http://p42inwwpb.bkt.clouddn.com/',   //bucket 域名，下载资源时用到，**必需**
                ...
                init: {
                    ...
                    'FileUploaded': function(up, file, info) {
                        ...
                        let sourceLink = domain + encodeURIComponent(res.key);
                        let sourceName = res.key
                        window.x = "open"
